...
Route::group(['prefix'  =>  'admin'], function () {
    ...
    Route::group(['middleware' => ['auth:admin']], function () {
        ...
        Route::group(['prefix'  =>   'fournisseur'], function() {
            ...
            Route::get('/', 'Admin\FournisseurController@index')->name('admin.fournisseur.index');
            Route::get('/create', 'Admin\FournisseurController@create')->name('admin.fournisseur.create');
            Route::post('/store', 'Admin\FournisseurController@store')->name('admin.fournisseur.store');
            Route::get('/{id}/edit', 'Admin\FournisseurController@edit')->name('admin.fournisseur.edit');
            Route::post('/update', 'Admin\FournisseurController@update')->name('admin.fournisseur.update');
            Route::get('/{id}/delete', 'Admin\FournisseurController@delete')->name('admin.fournisseur.delete');
